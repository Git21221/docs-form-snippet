...
const SidebarItems = ({ data }) => {
  ...
  return (
    <div className=" flex flex-col h-max">
      <div
        className={`px-1.5 py-0.5 mt-1.5 font-semibold rounded-md flex items-center justify-between text-zinc-700 text-lg overflow-hidden text-ellipsis cursor-pointer hover:bg-slate-200`}
